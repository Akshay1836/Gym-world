        ...
        <div class="2xl:px-20 lg:px-12 px-4 flex flex-wrap items-start mt-4 pr-2 bg-cyan-800">
            <div class="mt-24 p-4">
                <div class="flex gap-1 items-center justify-between px-4">
                    <img tabindex="0" src="./src/images/main.jpg"  class="w-20 h-20 rounded-lg mr-8" />
                    <img tabindex="0" src="./src/images/circle1.jpg" class="w-48 h-36 rounded-lg" />
                </div>
                <div class="flex items-center justify-end my-2 p-2">
                    <img tabindex="0" src="./src/images/circle2.jpg" class="w-48 h-36 rounded-lg"/>
                </div>
                <div class="flex gap-1 items-start p-2">
                    <img tabindex="0" src="./src/images/circle4.jpg"  class="w-48 h-48 rounded-lg" />
                    <img tabindex="0" src="./src/images/core.jpg" class="w-20 h-20 rounded-lg ml-6 flex-shrink-0 object-cover object-fit" />
                </div>
            </div>
            <div class="ml-6 mt-32 p-2">
                <img tabindex="0" src="./src/images/strong.jpg" class="w-40 h-40 rounded-lg ml-6 flex-shrink-0 object-cover object-fit" />
                <div class="flex gap-1 items-center mt-8">
                    <img tabindex="0" src="./src/images/cross.jpg" class="w-48 h-48 rounded-lg" />
                    <img tabindex="0" src="./src/images/gym2.jpg" class="w-20 h-20 rounded-lg ml-6 object-cover object-fit" />
                </div>
            </div>
            <div class="mt-14 ml-2 p-2">
                <div class="lg:flex p-4">
                    ...
                    <div className=''>
                        ...
                        <img tabindex="0" src="./src/images/zumba.jpg" class="ml-6 mt-6 w-40 h-32 rounded-lg" />
                    </div>
                </div>
